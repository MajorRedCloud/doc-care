...
const RenderField = ({field, props}: {field:any, props:Props}) => {
  switch (props.fieldType) {
    case FormFieldType.INPUT:
      return(
        <div className={`flex rounded-md border border-dark-500 bg-dark-400 ${props.className}`}>
          {props.iconSrc && (
            <Image 
              src={props.iconSrc}
      ...
      return(
        <FormControl>
          <div className="flex items-center gap-4">
            ...
            />
            <label htmlFor={props.name} className="checkbox-label font-bold">{props.label}</label>
          </div>
        </FormControl>
      )
      default:
